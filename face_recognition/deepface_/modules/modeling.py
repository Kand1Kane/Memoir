...
from deepface_.models.facial_recognition import (
    VGGFace,
    OpenFace,
    FbDeepFace,
    DeepID,
...
from deepface_.models.face_detection import (
    FastMtCnn,
    MediaPipe,
    MtCnn,
    OpenCv,
...
from deepface_.models.demography import Age, Gender, Race, Emotion
from deepface_.models.spoofing import FasNet
